...
#define REQUIRE_ACTIVE_METHOD(method, site) il2cpp::vm::AssemblyShadow::RequireActiveMethod(method, site)
#else
#define REQUIRE_ACTIVE_METHOD(method, site) ((void)0)
#endif
...
#define MEMORY_BARRIER() il2cpp::os::Atomic::FullMemoryBarrier()
	...
	{
		REQUIRE_ACTIVE_METHOD(ctor, "Interpreter.delegateConstructor");
#if HYBRIDCLR_UNITY_2021_OR_NEW
...
#define PREPARE_NEW_FRAME_FROM_NATIVE(newMethodInfo, argBasePtr, retPtr) { \
	REQUIRE_ACTIVE_METHOD(newMethodInfo, "Interpreter.entry"); \
...
#define PREPARE_NEW_FRAME_FROM_INTERPRETER(newMethodInfo, argBasePtr, retPtr) { \
	REQUIRE_ACTIVE_METHOD(newMethodInfo, "Interpreter.nestedCall"); \
	imi = newMethodInfo->interpData ? (InterpMethodInfo*)newMethodInfo->interpData : InterpreterModule::GetInterpMethodInfo(newMethodInfo); \
	RuntimeInitClassCCtorWithoutInitClass(newMethodInfo); \
...
{
	REQUIRE_ACTIVE_METHOD(method, "Interpreter.delegateTarget");
...
#pragma region FUNCTION
		//!!!{{FUNCTION
				case HiOpcodeEnum::NewClassVar:
				{
					...
					REQUIRE_ACTIVE_METHOD(__method, "Interpreter.newobj");
				...
				case HiOpcodeEnum::CallNativeInstance_void:
				{
				    ...
				    REQUIRE_ACTIVE_METHOD(((MethodInfo*)imi->resolveDatas[__methodInfo]), "Interpreter.nativeInstanceCall");
				...
				case HiOpcodeEnum::CallNativeStatic_void:
				{
				    ...
				    REQUIRE_ACTIVE_METHOD(_resolvedMethod, "Interpreter.directCall");
				...
				case HiOpcodeEnum::CallVirtual_void:
				{
				    ...
				    REQUIRE_ACTIVE_METHOD(_actualMethod, "Interpreter.virtualTarget");
				...
				case HiOpcodeEnum::CallInd_void:
				{
					...
					if (__isMethodInfoPointer == 1)
					{
					    ...
					    REQUIRE_ACTIVE_METHOD(_method, "Interpreter.indirectMethodTarget");
				...
				case HiOpcodeEnum::CtorDelegate:
				{
					...
					REQUIRE_ACTIVE_METHOD(__ctor, "Interpreter.newDelegateConstructor");
					uint16_t __obj = *(uint16_t*)(ip + 4);
					uint16_t __method = *(uint16_t*)(ip + 6);
